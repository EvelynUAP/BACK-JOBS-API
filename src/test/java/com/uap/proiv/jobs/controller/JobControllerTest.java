...
public class JobControllerTest{
    ...
    void setup() {
        ...
        user1.setFirstName("Evelyn");
        user1.setLastName("Inostroza");
        users.add(user1);
        ...
        when(userService.search(1)).thenReturn(userApiResponse).thenReturn(userApiResponse)
        .thenThrow(new RuntimeException("MSG")).thenReturn(userApiResponse);
    ...
    void postAssign_success() throws Exception {
        ...
        mockMvc.perform(post("/api/job/assign")
                ...
                .andExpect(jsonPath("$.Assign[0].users[0].first_name").value("Evelyn"))
